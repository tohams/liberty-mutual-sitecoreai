...
| `PORTAL_PERSONALIZATION_DIAGNOSTICS` | Opt-in safe stage diagnostics; disabled unless exactly `true`. Reports booleans, fixed outcome categories, receipt type and elapsed milliseconds only |
