...
5. Choose **Publish Page** for the current page in **English**, with **Subpages**, **All references** and **Include related items** all off. Confirm the scoped publication completes, then verify the new summary in the live article and resource listing.
...
- Agentic artifact reviewed; historical excerpt input, separate retrieval proof and projected-color limitation stated:
