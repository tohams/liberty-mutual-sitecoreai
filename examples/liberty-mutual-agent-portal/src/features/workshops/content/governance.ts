...
export const governanceGuides: WorkshopGuide[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: [
          "Open [**the Demo live page**](https://liberty-mutual-agent-portal.vercel.app/workshop-practice/pair-01). If asked to sign in, use the presenters’ **Daniel** portal login for workshop number **01** and password **Sitecore**. After sign-in, reopen [**the Demo live page**](https://liberty-mutual-agent-portal.vercel.app/workshop-practice/pair-01).",
    ...
    cleanup: {
      ...
      body: [
        ...
        "Resetting a workshop number affects portal activity, not CMS content. Restore this page through the submission and approval steps in this cleanup section. Close extra **Page Builder** and live-page tabs when finished.",
      ],
    },
