      ...
      focus(
        {
          ...
          title: "Find the Businessowners policy actions",
          alt: "Small business product cards with Texas preparation context and Businessowners policy actions",
          caption:
            "This view is below the spotlight on **Products & appetite**, after selecting **Texas**. Use the **Businessowners policy** card for this exercise.",
        },
        { ...portal, x: 263, y: 466, width: 1014, height: 495 },
        [
          {
            x: 497,
            y: 479,
            width: 118,
            height: 40,
            label: "Select the **Small business** tab.",
          },
          {
            x: 1091,
            y: 537,
            ...
            height: 29,
            label:
              "Confirm **Product preparation for Texas** before continuing.",
          },
          {
            x: 295,
            y: 874,
            ...
            height: 31,
            label:
              "Click **Explore coverage** on **Businessowners policy**, then return to this card.",
          },
          {
            x: 296,
            y: 907,
            ...
            height: 28,
            label:
              "Click **Prepare account** on the same card to open the intake.",
          },
        ],
      ),
      focus(
        {
          ...
          title: "Confirm the carried-forward coverage and state",
          alt: "Prepare your submission coverage and fit screen with Businessowners policy, Texas, and the business type dropdown",
          caption:
            "The first **Prepare your submission** screen carries **Businessowners policy** and **Texas** into the intake. This reference is before choosing **Retail**; the continuation button becomes available after choosing the business type.",
        },
        { ...portal, x: 242, y: 175, width: 820, height: 650 },
        [
          {
            x: 268,
            y: 350,
            ...
            height: 74,
            label:
              "Check the carried-forward **Businessowners policy** coverage.",
          },
          {
            x: 268,
            y: 440,
            width: 376,
            height: 71,
            label: "Confirm **Risk state** is **Texas**.",
          },
          {
            x: 658,
            y: 440,
            width: 380,
            height: 71,
            label: "Choose **Retail** in **Business type**.",
          },
          {
            x: 794,
            y: 751,
            ...
            height: 49,
            label:
              "Click **Continue to account information** to reach the next step’s account fields.",
          },
        ],
      ),
    ],
