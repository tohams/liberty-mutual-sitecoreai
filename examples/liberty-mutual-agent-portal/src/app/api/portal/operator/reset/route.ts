...
import { getReviewerResetStatus, requestReviewerRestart } from '@/server/data/reviewer-restart';
...
export async function POST(request: Request) {
  try {
    ...
    const receipt = await requestReviewerRestart({ reviewerPack: body.reviewerPack, requestId: body.requestId, expectedRunId: body.expectedRunId });
